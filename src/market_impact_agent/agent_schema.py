...
AGENT_SCHEMA_FILES = (
    ...
    "modeled-pit-readiness-checkpoint.schema.json",
    ...
    "agent-portfolio-proposal-v6.schema.json",
    "dynamic-ashare-universe.schema.json",
    "research-thesis-v1.schema.json",
    "research-thesis-v2.schema.json",
    ...
    "order-intent-v2.schema.json",
    "trading-mandate.schema.json",
    "price-basis.schema.json",
    "hard-policy-evaluation.schema.json",
    "approval-decision.schema.json",
    "execution-receipt.schema.json",
    "cancellation-request.schema.json",
    "cancellation-approval.schema.json",
    "cancellation-command-receipt.schema.json",
